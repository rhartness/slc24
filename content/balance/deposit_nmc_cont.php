<div class="article">
<h2><span>Deposit Namecoins</span></h2>
<p>
...
$slt_address_a = "SELECT * FROM deposit_address WHERE user = '$_SESSION[user_id]' AND currency = 'NMC' ORDER BY creation_date DESC LIMIT 10";
